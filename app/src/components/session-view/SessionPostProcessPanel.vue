        ...
        <template v-if="isCompleted">
            ...
            >
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <button type="button" :disabled="moving" class="cursor-pointer rounded-lg border border-zinc-300 px-4 py-2 text-sm dark:border-zinc-600" @click="emit('cancelMove')">Cancel</button>
                </div>
            </div>
            ...
            >
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <button type="button" :disabled="renaming" class="cursor-pointer rounded-lg border border-zinc-300 px-4 py-2 text-sm dark:border-zinc-600" @click="emit('cancelRename')">Cancel</button>
                </div>
            </div>
