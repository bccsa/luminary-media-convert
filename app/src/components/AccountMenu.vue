...
<template>
    <div ref="rootEl" class="relative shrink-0">
        ...
        >
            <div
                v-if="open"
                class="absolute right-0 top-full z-50 mt-2 w-[min(18rem,calc(100vw-2rem))] origin-top-right rounded-xl border border-slate-200 bg-white py-1 shadow-xl ring-1 ring-slate-900/5 dark:border-slate-700 dark:bg-slate-900 dark:ring-white/10"
                role="menu"
                aria-label="Account"
                @click.stop
            >
                ...
                <div class="px-2 py-2" role="none">
                    ...
                    <div class="space-y-0.5" role="group" aria-labelledby="account-appearance-label">
                        <button
                            ...
                            class="flex w-full cursor-pointer items-center gap-2 rounded-lg px-2 py-2 text-left text-sm text-slate-800 transition-colors hover:bg-slate-50 dark:text-slate-200 dark:hover:bg-slate-800"
