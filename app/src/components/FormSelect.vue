...
/**
 * Select control — **native `<select>`** (`presentation="native"`) by default **only**
 * when you opt in or use the **`playback`** variant (narrow timeline toolbar).
 *
 * **`field`** and **`admin`** use **`presentation="auto"`** → **custom themed list panel**
 * (`FormSelectListbox`): full control over open-list styling via Tailwind theme.
 */
